...
{
	public static int DEFAULT_INDEX = -1;// { get; private set; }
	...
	public bool IsDeletable
	{
		...
		set
		{
			...
			if (_deleteButton != null)
			{
				if (_isDeletable)
				{
//					_deleteButton.SetState(UIButtonColor.State.Normal, true);
					_deleteButton.isEnabled = true;
				}
				else
				{
//					_deleteButton.SetState(UIButtonColor.State.Disabled, true);
...
//		get
//		{
//			return gameObject.transform.localPosition.y - (localSize.y / 2);
//		}
//	}
